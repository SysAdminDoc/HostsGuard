...
public class SchemaLockTests
{
    private const string Expected = """
        ...
        service DnsControl
          AcceptEncryptedResolverBaseline(Empty) returns (EncryptedResolverDiscoveryReport)
          FlushCache(Empty) returns (Ack)
          FlushCacheEntry(DnsCacheEntryRequest) returns (Ack)
          GetDohStatus(Empty) returns (DohStatus)
          GetEncryptedResolverDiscovery(Empty) returns (EncryptedResolverDiscoveryReport)
          ...
          RunEncryptedResolverDiscovery(Empty) returns (EncryptedResolverDiscoveryReport)
        ...
        service HostsControl
          ...
          ListRedirects(Empty) returns (RedirectList)
        ...
        service ListControl
          ...
          ImportBlocklistContent(BlocklistContentRequest) returns (BlocklistResult)
          ...
          PreviewBlocklistContent(BlocklistContentRequest) returns (BlocklistResult)
        ...
        service Monitoring
          ...
          DeleteHistoryPrivacyExclusion(HistoryPrivacyExclusion) returns (Ack)
          ...
          SetHistoryPrivacyExclusion(HistoryPrivacyExclusion) returns (Ack)
