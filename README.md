...
dotnet test HostsGuard.sln           # 810 tests, no elevation needed
...
# Produces installer_output/HostsGuard-v0.12.24-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.24-win-arm64-dotnet-Setup.exe
```
