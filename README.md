...
![Version](https://img.shields.io/badge/version-0.12.29-blue)
...
dotnet test HostsGuard.sln           # 816 tests, no elevation needed
...
# Produces installer_output/HostsGuard-v0.12.29-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.29-win-arm64-dotnet-Setup.exe
```
