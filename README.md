...
![Version](https://img.shields.io/badge/version-0.12.30-blue)
...
# Produces installer_output/HostsGuard-v0.12.30-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.30-win-arm64-dotnet-Setup.exe
```
