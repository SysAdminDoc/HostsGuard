...
![Version](https://img.shields.io/badge/version-0.12.66-blue)
...
# Produces installer_output/HostsGuard-v0.12.66-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.66-win-arm64-dotnet-Setup.exe
```
