...
dotnet test HostsGuard.sln           # 807 tests, no elevation needed
...
# Produces installer_output/HostsGuard-v0.12.22-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.22-win-arm64-dotnet-Setup.exe
```
