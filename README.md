...
dotnet test HostsGuard.sln           # 804 tests, no elevation needed
...
# Produces installer_output/HostsGuard-v0.12.20-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.20-win-arm64-dotnet-Setup.exe
```
