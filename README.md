...
![Version](https://img.shields.io/badge/version-0.12.62-blue)
...
# Produces installer_output/HostsGuard-v0.12.62-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.62-win-arm64-dotnet-Setup.exe
```
