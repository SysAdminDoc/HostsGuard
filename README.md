...
![Version](https://img.shields.io/badge/version-0.12.26-blue)
...
dotnet test HostsGuard.sln           # 812 tests, no elevation needed
...
# Produces installer_output/HostsGuard-v0.12.26-win-x64-dotnet-Setup.exe
#          installer_output/HostsGuard-v0.12.26-win-arm64-dotnet-Setup.exe
```
